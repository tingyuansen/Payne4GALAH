...
def fit_global(spectrum, spectrum_err, spectrum_blaze, wavelength,
    ...
    GALAH spectrum typically has about ~35 orders in the red
    ...
    popt_best, model_spec_best, chi_square = fitting_galah(spectrum, spectrum_err, spectrum_blaze,\
...
def fitting_galah(spectrum, spectrum_err, spectrum_blaze,\
